...
import com.app.patient_tracker.util.FlywayCommandLineRunner;
...
class PatientServiceTest {
    ...
    private FlywayCommandLineRunner testDataLoader;


    @Test
    void checkIfPatientHasNextAppointment() {
        var patients = loadTestData();
    }
    ...
    @Test
    void fillOutProgress() {
    }

    @Test
    void getProgressNotesByPatientId() {
    }
